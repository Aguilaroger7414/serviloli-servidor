...
$routes->get('/prestamos/devolver/(:num)', 'PrestamoController::devolver/$1');
$routes->post('/prestamos/agregarHerramienta', 'PrestamoController::agregarHerramienta');
...
//CRUD HERRAMIENTAS
$routes->get('/herramientas', 'HerramientaController::index');
$routes->get('/herramientas/crear', 'HerramientaController::crear');
$routes->post('/herramientas/registrar', 'HerramientaController::registrar');
$routes->get('/herramientas/editar/(:num)', 'HerramientaController::editar/$1');
$routes->post('/herramientas/actualizar/(:num)', 'HerramientaController::actualizar/$1');
$routes->get('/herramientas/eliminar/(:num)', 'HerramientaController::eliminar/$1');

// * RUTAS DE REPORTES
$routes->get('/reportes', 'Home::reportes');
$routes->get('/reportes/prestamos-por-empleado', 'Home::prestamosPorEmpleado');
$routes->get('/reportes/herramientas-prestadas', 'Home::herramientasPrestadas');
