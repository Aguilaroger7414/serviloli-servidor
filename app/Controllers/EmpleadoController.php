...
class EmpleadoController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['empleados'] = $empleadoModel
            ...
            ->orderBy('empleado.id_empleado', 'asc')
            ->paginate(10);
    ...
    public function actualizar($id_empleado)
    {
        ...
        $puestoActual = $detEmpPuestoModel->where('id_empleado', $id_empleado)->orderBy('id_det_emp_puesto', 'asc')->first(); // buscamos el puesto actual registrado del empleado
